const { getFoodByCategoryService, getFoodService ,addFoodService ,deleteFoodService,updateFoodService} = require("../services/foodServices");
...
module.exports = { getFoodByCategory, getFood ,addFood,deleteFood, updateFood};
